    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(get_package_share_directory('zbot_franka_description'), 'launch', 'description.launch.py')
            ),
            launch_arguments={'load_gripper': LaunchConfiguration('load_gripper')}.items(),
        ),
